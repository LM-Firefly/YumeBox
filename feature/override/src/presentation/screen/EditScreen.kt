...
import com.github.yumelira.yumebox.presentation.component.OpenJsonEditor
...
fun OverrideEditScreen(
    ...
    onOpenRuleListEditor: OpenRuleListEditor = { _, _, _, _, _, _ -> },
    onOpenJsonEditor: OpenJsonEditor = { _, _, _, _ -> },
    onOpenObjectListEditor: OpenStructuredObjectListEditor = { _, _, _, _, _, _, _ -> },
    onOpenObjectMapEditor: OpenObjectMapEditor = { _, _, _, _, _, _ -> },
    onOpenSubRulesEditor: OpenSubRulesEditor = { _, _, _, _, _, _ -> },
) {
