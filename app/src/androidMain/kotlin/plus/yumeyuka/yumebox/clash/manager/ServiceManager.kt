...
class ServiceManager(
    ...
    private fun startMonitoring() {
        ...
        trafficMonitorJob = scope.launch {
            while (isActive) {
                runCatching {
                    stateManager.updateTrafficNow(com.github.yumelira.yumebox.domain.model.TrafficData.from(Clash.queryTrafficNow()))
                    stateManager.updateTrafficTotal(com.github.yumelira.yumebox.domain.model.TrafficData.from(Clash.queryTrafficTotal()))
