...
object NativeLibraryManager {
    ...
    fun extractLibrary(info: LibraryInfo): Boolean {
        ...
        return runCatching {
            ...
            Timber.w(e, MLang.Util.Native.ExtractFailed.format(info.name))
            false
        }
    }
    ...
    private fun extractFromExtensionApk(info: LibraryInfo, targetFile: File): Boolean {
        ...
        ZipFile(extensionApk).use { zip ->
            ...
            if (entry == null) {
                Timber.w("Library ${info.name} not found in extension APK")
                return false
            }
    ...
    fun loadJniLibrary(name: String): Boolean {
        ...
        return runCatching {
            ...
            Timber.e(e, MLang.Util.Native.LoadJniFailed.format(name))
            false
        }
    }
