...
class FeatureViewModel(
    ...
    fun downloadSubStoreFrontend() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            }.onFailure { e -> Timber.e(e, MLang.Feature.SubStore.DownloadError.format(e.message ?: "")); showToast(MLang.Feature.SubStore.DownloadError.format(e.message)) }
    ...
    fun downloadExternalPanelEnhanced(panelType: Int = 0) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            }.onFailure { e -> Timber.e(e, MLang.Feature.SubStore.PanelInstallError.format(e.message ?: "")); showToast(MLang.Feature.SubStore.PanelInstallError.format(e.message)) }
