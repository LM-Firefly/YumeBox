...
val javaVersionInt = minOf(jvmVersionNumber.toString().toInt(), 17)
val javaVersion = JavaVersion.toVersion(javaVersionInt) ?: JavaVersion.VERSION_17
...
kotlin {
    androidTarget()
    val toolchainVersion = kotlinJvmTargetInt
